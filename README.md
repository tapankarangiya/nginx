...
# How it works
NGINX is installed software with binary packages available This is 3rd branch for all major operating systems and Linux distributions. See [Tested OS and Platforms](https://nginx.org/en/#tested_os_and_platforms) for a full list of compatible systems.
